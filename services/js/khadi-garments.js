/* Khadi Garments Manufacturing — page-specific script */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Log page view for "Khadi Garments Manufacturing" (placeholder for analytics hook)
  console.log('Viewing service page: Khadi Garments Manufacturing');
});
