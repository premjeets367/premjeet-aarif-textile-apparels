/* Dari Manufacturing — page-specific script */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Log page view for "Dari Manufacturing" (placeholder for analytics hook)
  console.log('Viewing service page: Dari Manufacturing');
});
