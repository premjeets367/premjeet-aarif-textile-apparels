/* Cricket Gloves Manufacturing — page-specific script */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Log page view for "Cricket Gloves Manufacturing" (placeholder for analytics hook)
  console.log('Viewing service page: Cricket Gloves Manufacturing');
});
