/* Sweater Manufacturing — page-specific script */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Log page view for "Sweater Manufacturing" (placeholder for analytics hook)
  console.log('Viewing service page: Sweater Manufacturing');
});
